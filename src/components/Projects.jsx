...
const getProjectIcon = (name) => {
  ...
  if (n.includes("erp") || n.includes("management")) return <HiDatabase size={20} />;
...
export default function Projects() {
  const projects = [
    ...
    },
    {
      ...
      description: "Enterprise solution for production logs. Improved data entry efficiency by 40%.",
  ...
  return (
    <section id="projects" className="py-24 bg-[#020617] text-slate-300 px-6 font-['JetBrains_Mono',monospace]">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Section Header as a Code Comment */}
        <div className="mb-16">
          ...
          {projects.map((proj) => (
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <button className="flex items-center gap-2 text-[10px] font-bold text-white border-b border-indigo-500/0 hover:border-indigo-500 transition-all uppercase tracking-widest">
                  View_Source <HiExternalLink />
                </button>
              </div>
            </div>
          ))}
        ...
        <div className="mt-16 p-4 border-l-2 border-indigo-500 bg-indigo-500/5 flex gap-4 items-start max-w-2xl">
          ...
          <p className="text-[11px] leading-relaxed text-slate-400">
            <span className="text-white font-bold uppercase">Note:</span> All 'Stable' artifacts have passed unit testing and are containerized for deployment. Click 'View_Source' for implementation details.
          </p>
        </div>
      </div>
    </section>
